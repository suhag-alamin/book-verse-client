  ...
  return (
    <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t-bookVersePrimary border-t">
      <div className="text-center">
        <div className="text-center">
          <Link to="/">
            <img className="h-12 w-auto mx-auto" src={logo} alt="" />
          </Link>
        </div>

        <div className="mt-3 w-2/3 mx-auto text-center">
          <p className="text-gray-500 ">
            BookVerse is a free service that helps you discover books you'll
            love through unbeatable deals, handpicked recommendations, and
            updates from your favorite authors.
          </p>
          <p className="text-gray-500">
